...
export default function Stepper2() {
  return (
    <div className="relative w-240 px-0 py-8 ml-30">
      {/* Horizontal line behind circles */}
      <div className="absolute top-13 left-5 right-5 h-1 bg-bg2" />

      {/* Circles */}
      <div className="flex justify-between items-center relative z-10">
        <div className="w-10 h-10 border-2 border-teal-700 rounded-full " />
        <div className="w-10 h-10 border-2 border-teal-700 rounded-full " />
        <div className="w-10 h-10 border-2 border-teal-700 rounded-full " />
      </div>

      {/* Labels below circles */}
      <div className="mt-10 flex justify-between  relative z-10  text-white  w-300">
