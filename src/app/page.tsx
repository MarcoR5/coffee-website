...
export default function Home() {
  return (
    ...
    <div className="bg-[url(./img/background.png)] ... w-full h-full bg-no-repeat bg-cover bg-center rounded-lg">
      ...
      <p className={`text-lg text-gray-300 ${inter.className}`}>Start your mornings with the world's best coffees. Try our <br /> expertly curated artisan coffees from our best roasters <br /> delivered directly to your door, at your scedule.</p>
    ...
    <div className="w-screen h-screen flex flex-col items-center justify-center">
      ...
      <div className="flex space-x-20 -mt-10">
        <div className="w-90 h-150  flex flex-col items-center text-center space-y-10 text-blue">
         ...
         <p className={inter.className} >Light and flavorful blend with cocoa <br /> and black pepper for an intense <br /> experience.</p>
        </div>
        <div className="w-90 h-150 flex flex-col items-center text-center space-y-10 text-blue">
         <div className="bg-[url(./img/coffee.png)] ... w-50 h-50 bg-no-repeat bg-cover bg-center space-y-5"></div>
          ...
          <p  className={inter.className}>Brazilian dark roast with rich and <br /> velvety body, and hints of fruits and <br />nuts.</p>
        </div>
        <div className="w-90 h-150 flex flex-col items-center text-center space-y-10 text-blue">
         <div className="bg-[url(./img/coffee.png)] ... w-50 h-50 bg-no-repeat bg-cover bg-center"></div>
          <h2 className="font-bold text-3xl">Picollo</h2>
          <p  className={inter.className}>Mild and smooth blend featuring <br /> notes of toasted almond and dried <br /> cherry.</p>
        </div>
        <div className="w-90 h-150 flex flex-col items-center text-center space-y-10 text-blue">
         <div className="bg-[url(./img/coffee.png)] ... w-50 h-50 bg-no-repeat bg-cover bg-center"></div>
        <h2 className={`text-3xl font-bold`}>Danche</h2>
        <p className={inter.className}>Ethiopian hand-harvested blend <br /> densely packed with vibrant fruit <br /> notes.</p>
        </div>
    ...
    <div className="w-screen h-screen text-center ">
        ...
        <p className={`mt-10 text-xl ${inter.className}`}>A large part of our role is choosing which particular coffees will be featured <br /> in our range. This means working closely with the best coffee growers to give <br /> your more impactful experience on every level.</p>
        {/* 3 panels */}
        <div className="flex space-x-15 w-full justify-center mt-30">
          <div className="bg-bg w-[25%] h-100 rounded-lg flex flex-col items-center ">
            ...
            <p className={`text-lg ${inter.className}`}>Discover an endless variety of the <br /> world's best artisan coffee from <br />each of our roasters.</p>
          </div>
          <div className="bg-bg w-[25%] h-100 rounded-lg flex flex-col items-center ">
            ...
            <p className={`text-lg ${inter.className}`}>Special offers and swag when you <br /> subscribe, including 30% off your <br /> first shipment</p>
          </div>
          <div className="bg-bg w-[25%] h-100 rounded-lg flex flex-col items-center ">
            ...
            <p className={`text-lg ${inter.className}`}>We cover the cost and coffee is <br /> delivered fast. Peak freshness: <br />guaranteed.</p>
          </div>
