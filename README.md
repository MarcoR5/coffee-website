...
About coffee or brand section

Menu or products display
...
Static product/menu showcase

Contact form (static or with basic front-end validation)
...
Optional: CSS frameworks like Bootstrap / Tailwind (if used)
